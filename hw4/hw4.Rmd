...
ggplot(average_time_by_year, aes(year, avg_time)) +
  geom_bar(stat = 'identity')
# Code breaking here as well.
...
# Do you observe a difference across the two game systems?
```
