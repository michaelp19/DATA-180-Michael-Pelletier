...
ggplot(data = Cars93, aes(x = EngineSize, y = MPG.city)) +
  ...
  labs(
    title = "Scatterplot of Engine Size vs. City MPG",
    subtitle = "Using the cars93 dataset",
    x = "Engine Size",
    y = "City MPG",
    caption = "Data source: cars93 dataset"
  )
...
ggplot(data = Cars93, aes(x = EngineSize, y = MPG.city, color = Type)) +
  ...
  labs(
    title = "Scatterplot of Engine Size vs. City MPG by Car Type",
    subtitle = "Using the cars93 dataset",
    x = "Engine Size",
    y = "City MPG",
    caption = "Data source: cars93 dataset"
...
ggplot(data = Cars93, aes(x = EngineSize, y = MPG.city, color = Type)) +
  ...
  geom_smooth(method = NULL, formula = y ~ x, linetype = "dashed", color = "red")
...
ggplot(data = Cars93, aes(x = Origin, fill = AirBags)) +
  ...
  labs(
    title = "Count of Cars by AirBags and Origin",
    subtitle = "Using the cars93 dataset",
    x = "Origin",
    y = "Count",
    caption = "Data source: cars93 dataset"
...
ggplot() +
  ...
  labs(
    ...
    subtitle = "Using ggplot2 and ozmaps",
...
```{r}
# Create the map of Australia (from Task 1)
au_map <- ggplot() +
  geom_sf(data = au_states, aes(fill = NAME)) +
  labs(
    title = "Map of Australia",
...
# Display capital cities as points
au_map +
...
capitals_geo <- st_as_sf(au_capitals, coords = c("lon", "lat"))
au_states <- ozmaps::ozmap_states
mapview(au_states)+mapview(capitals_geo)
