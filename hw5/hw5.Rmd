...
# Set row and column names separately
...
c) Average-neighbor
The inter-group distance between A and B using the average-neighbor method is approximately 5.43.
# Question 4
...
vertebrate <- read_csv("/Users/michaelpelletier/Desktop/Data 180-Michael Pelletier version2 /DATA-180-Michael-Pelletier/hw5/vertebrate.csv")
...
```{r}
# Create ggdendro dendrogram for Euclidean metric with complete linkage
dendro_euclidean <- ggdendro(complete_linkage_euclidean)

# Plot dendrogram with customizations
plot(dendro_euclidean, lwd = lwd_value,
     main = title_euclidean, sub = "", xlab = "Vertebrates", cex.lab = 1.25, hang = -1)
